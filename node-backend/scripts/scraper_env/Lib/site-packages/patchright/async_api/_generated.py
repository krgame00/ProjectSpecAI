...
from patchright._impl._credentials import Credentials as CredentialsImpl
from patchright._impl._debugger import Debugger as DebuggerImpl
from patchright._impl._dialog import Dialog as DialogImpl
from patchright._impl._disposable import Disposable as DisposableImpl
...
from patchright._impl._form_data import FormData
from patchright._impl._frame import Frame as FrameImpl
from patchright._impl._helper import to_milliseconds
...
from patchright._impl._screencast import Screencast as ScreencastImpl
...
from patchright._impl._web_storage import WebStorage as WebStorageImpl
...
class Route(AsyncBase):
    ...
    async def fallback(
        ...
        *,
        ...
        headers: typing.Optional[typing.Dict[str, str]] = None,
        post_data: typing.Optional[typing.Union[typing.Any, str, bytes]] = None,
        patchrightInitScript: typing.Optional[bool] = None,
    ) -> None:
        """Route.fallback
        ...
        **Usage**
        ...
        return mapping.from_maybe_impl(
            await self._impl_obj.fallback(
                ...
                headers=mapping.to_impl(headers),
                postData=mapping.to_impl(post_data),
                patchrightInitScript=patchrightInitScript,
            )
        )
