...
from patchright._impl._screencast import Screencast
from patchright._impl._video import Video
from patchright._impl._waiter import Waiter
from patchright._impl._web_storage import WebStorage
...
class Page(ChannelOwner):
    ...
    async def aria_snapshot(
        ...
        return await self._main_frame._channel.send(
            "ariaSnapshot", self._main_frame._timeout, locals_to_params(locals())
        )
