...
class FallbackOverrideParameters(TypedDict, total=False):
    ...
    patchrightInitScript: Optional[bool]
...
class SerializedFallbackOverrides:
    def __init__(self) -> None:
        ...
        self.patchright_init_script: bool = False
...
class Route(ChannelOwner):
    ...
    async def fallback(
        ...
        headers: Dict[str, str] = None,
        postData: Union[Any, str, bytes] = None,
        patchrightInitScript: Optional[bool] = None,
    ) -> None:
        ...
        await self._race_with_page_close(
            self._channel.send(
                ...
                None,
                {
                    ...
                    "patchrightInitScript": True
                    if options.patchright_init_script
                    else None,
                },
            )
        )
