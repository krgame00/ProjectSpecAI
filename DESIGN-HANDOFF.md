# a68a2f1a-36aa-44e9-ba2d-9de75c6083be implementation handoff

This archive is the source of truth for turning the design into production code. Start from `smart-pc-builder.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `smart-pc-builder.html`
...
- A single self-contained `smart-pc-builder.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `smart-pc-builder.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `smart-pc-builder.html`

## Styles
- None detected

## Scripts/components
- `node-backend/routes/chatbot.js`
- `node-backend/routes/hardware.js`
- `node-backend/routes/orders.js`
...
- `vue-components/ChatbotWindow.vue`
- `vue-components/HardwareSelection.vue`
- `vue-components/PriceSummary.vue`

## Coding checklist for AI tools
1. Inspect `smart-pc-builder.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
